...
This file is deployed as a Python Function at `/api/*`.
Artifacts are bundled in `api/artifacts/`.
"""
...
def load_artifacts() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"Missing in {ARTIFACTS_DIR}: {', '.join(missing)}")
...
# Local dev: serve UI from ../public
